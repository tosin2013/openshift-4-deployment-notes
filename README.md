...
This repository includes GitHub Actions workflows for automating OpenShift 4.18 installations across multiple cloud platforms:

* [AWS OpenShift Installation](.github/workflows/aws-openshift-install.yml)
* [ROSA OpenShift Installation](.github/workflows/rosa-openshift-install.yml)
* [GCP OpenShift Installation](.github/workflows/gcp-openshift-install.yml)
* [Azure OpenShift Installation](.github/workflows/azure-openshift-install.yml)
* [ARO OpenShift Installation](.github/workflows/aro-openshift-install.yml)

For more information about the workflows, see the [workflows README](.github/workflows/README.md) and the [Vault setup guide](vault-setup-guide.md).
