#!/bin/bash
## For use with the openshift-aio deployments
## https://github.com/RHFieldProductManagement/openshift-aio
#set -x
#set -e
...
export CLUSTER_NAME="aio"
export CLUSTER_BASE_DNS="example.com"
export CLUSTER_INGRESS_VIP="192.168.123.11"
export CLUSTER_API_VIP="192.168.123.10"
export CLUSTER_MACHINE_NETWORK="192.168.123.0/24"
export NTP_SOURCE="time1.google.com"

#########################################################
## Additional Node + Network Configuration
export CLUSTER_NODE_NET_DNS_SERVERS=("192.168.123.100" "1.1.1.1")

## Set Node Network Configuration
NODE1_CFG='{"name": "ocp01", "mac_address": "de:ad:be:ef:00:01", "ipv4": {"address": "192.168.123.51", "gateway": "192.168.123.1", "prefix": "24", "iface": "enp1s0"}}'
NODE2_CFG='{"name": "ocp02", "mac_address": "de:ad:be:ef:00:02", "ipv4": {"address": "192.168.123.52", "gateway": "192.168.123.1", "prefix": "24", "iface": "enp1s0"}}'
NODE3_CFG='{"name": "ocp03", "mac_address": "de:ad:be:ef:00:03", "ipv4": {"address": "192.168.123.53", "gateway": "192.168.123.1", "prefix": "24", "iface": "enp1s0"}}'
